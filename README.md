[![Run App Harden, Alek](https://github.com/AlekHarden/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/AlekHarden/GithubActions/actions/workflows/ci.yml)
